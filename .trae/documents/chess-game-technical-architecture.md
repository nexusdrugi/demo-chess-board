...
interface GameState {
  ...
  pendingPromotion: PendingPromotion | null; // UI request for pawn promotion
}
}
...
type GameAction = 
  ...
  | { type: 'COMPLETE_PROMOTION'; piece: 'queen' | 'rook' | 'bishop' | 'knight' }
...
- En passant notation: "exd6 e.p." implemented; promotion notation and execution implemented (e.g., "e8=Q" and "exd8=Q").
